...
export class Query3Component implements OnInit {
  ...
  base64Image: any;
  imgsrc :'http://127.0.0.1:5000//api/TweetsAnalysis/query3Plot';
  ...
  ngOnInit(): void {
    let outputUrl = 'http://127.0.0.1:5000/api/TweetsAnalysis/query3Output';
   ...
   let imageUrl = 'http://127.0.0.1:5000/api/TweetsAnalysis/query3Plot';
