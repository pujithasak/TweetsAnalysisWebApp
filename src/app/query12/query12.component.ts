...
export class Query12Component implements OnInit {
  ...
  base64Image: any;
  imgsrc :'http://127.0.0.1:5000//api/TweetsAnalysis/query12Plot';
  ...
  ngOnInit(): void {
    let outputUrl = 'http://127.0.0.1:5000/api/TweetsAnalysis/query12Output';
   ...
   let imageUrl = 'http://127.0.0.1:5000/api/TweetsAnalysis/query12Plot';
